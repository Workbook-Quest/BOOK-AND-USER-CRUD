<?php
    ...
    if(isset($_POST["addUser"]))
    {
        ...
        if($errorCount == 0)
        {
            $sql = "INSERT INTO tblbuyer(UsernameBuyer,BuyerName,BuyerSurname,BuyerEmail,BuyerPassword,StudentNumber)
                    VALUES(NULL,'$name','$surname','$email','$pwd','$stdNum')";                       
...
<html>
    ...
    <div class="container">  
        <form action="" method="POST">
            ...
            <div class="reg">
            <button type="submit" name="addUser" class="btn" style="color:white; line-height:1.6; margin-left:420px;">Add</button>
            </div>
        </form>
</div>
</div>
